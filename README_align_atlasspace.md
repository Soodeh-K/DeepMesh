...
## Overview
The **align_atlasspace.py** processes 4D cardiac data by applying **Rigid Registeration** to align subject meshes with an atlas and transforem all the subjects from subject space to atlas space. It utilizes libraries such as **VTK** and  **IRTK** for mesh handling.
